# Generated by Django 3.1.3 on 2020-12-07 17:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='User', to='ImageDRF.accountuser')),
            ],
        ),
        migrations.AddField(
            model_name='accountuser',
            name='account',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Account', to='ImageDRF.plan'),
        ),
        migrations.AddField(
            model_name='accountuser',
            name='user_account',
